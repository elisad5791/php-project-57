<x-app-layout>
    <div>
        <h1 class="text-4xl mt-4">Задачи</h1>
        <a href="{{ route('tasks.create') }}" class="inline-block rounded-lg bg-indigo-600 mt-4 px-4 py-1.5 text-base font-semibold leading-7 text-white shadow-sm ring-1 ring-indigo-600 hover:bg-indigo-700 hover:ring-indigo-700">
            Создать
        </a>
